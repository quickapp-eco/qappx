...
describe('Modules', () => {
  ...
  describe('modules usage', () => {
    ...
    it('state as function (same module in multiple stores)', () => {
      ...
      const storeA = new Qappx.Store({
        modules: {
          foo: module
        }
      })

      const storeB = new Qappx.Store({
        modules: {
          bar: module
        }
      })
    ...
    it('module: nested namespace', () => {
      ...
      const store = new Qappx.Store({ modules })
    ...
    it('module: warn when module overrides state', () => {
      ...
      expect(console.warn).toHaveBeenCalledWith(
        `[qappx] state field "value" was overridden by a module with the same name at "foo.value"`
      )
    })
